...
# essential packages
packages="lightdm lightdm-gtk-greeter mesa zsh"
...
# sddm
curl -L https://github.com/catppuccin/sddm/releases/download/v1.0.0/catppuccin-mocha.zip -o ~/catppuccin-mocha.zip
