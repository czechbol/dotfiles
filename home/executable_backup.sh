...
mkdir -p /run/media/aludes/TravelHDD/backups/$host/{etc,home}
sudo rsync -zavx /etc/ /run/media/aludes/TravelHDD/backups/$host/etc/
sudo rsync -zavx \
  ...
  ~/ /run/media/aludes/TravelHDD/backups/$host/home/
